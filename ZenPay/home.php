...
<body>
    ...
    <div class="section-total">
        ...
        <div class="total-container">
            ...
            <div class="action-buttons">
                <div class="button-receita">
                    <a href="#" class="action-btn" id="btnReceita">
 ...
 <div class="button-conta-bancaria">

                  <!-- Botão Conta Bancária -->
<div class="button-conta-bancaria">
    <a href="#" class="action-btn" id="btnContaBancaria">
        <img src="img/receita-icon.png" alt="Conta Bancária">
        <span>Cartões</span>
    </a>
</div>
</div>
    
<div class="button-extrato">
    <!-- Botão para abrir o modal do extrato -->
    <a href="#" class="action-btn" id="btnExtrato">
        <img src="img/extrato-icon.png" alt="Extrato">
        <span>Extrato</span>
    </a>
</div>
...
<div id="addContaModal" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <!-- Modal para exibir o extrato bancário -->
<div id="extratoModal" class="modal">
    <div class="modal-content">
        <span class="close" id="closeExtratoModal">&times;</span>
        ...
        <table id="extratoTable">
            ...
            <tbody>
                <!-- Linhas preenchidas dinamicamente pelo PHP -->
            </tbody>
        </table>
    </div>
</div>
