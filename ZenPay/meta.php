...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Salva ou atualiza as metas na tabela 'metas'
    ...
    echo '';
    header('Location: meta.php?meta=salva');
    exit;
}
...
if ($meta = $result_meta->fetch_assoc()) {
...
<div class="content">
    <h1>Definir Metas</h1>
    <?php if (isset($_GET['meta']) && $_GET['meta'] == 'salva'): ?>
        <p>Metas salvas com sucesso!</p>
    <?php endif; ?>
    ...
    <div class="resultado-meta">
        <p>Meta de Gastos: R$ <?php echo number_format($meta_gastos, 2, ',', '.'); ?></p>
        <p>Meta de Poupança: R$ <?php echo number_format($meta_poupanca, 2, ',', '.'); ?></p>
    </div>
